...
class CustomResourceTestCase(KubernetesTestCase):
    ...
    def test_update_daemon_set_doesnt_exist(self):
        ...
        responses.add('POST', '/apis/extensions/v1beta1/namespaces/kube-extra/daemonsets', body=EMPTY_DAEMON_SET)
        # responses.add('PUT', '/api/v1/namespaces/kube-extra/services/registry-mirror-None', '')
